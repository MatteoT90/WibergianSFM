...
int call_sfm(std::string sSfM_Data_Filename, std::string sMatchesDir, std::string sOutDir)
{
...
int main(int argc, char **argv)
{
    ...
    int outcome;
    outcome= call_sfm(sSfM_Data_Filename, sMatchesDir, sOutDir);
    if (outcome == 0) return EXIT_FAILURE;
    return EXIT_SUCCESS;
}